...
Superseded in part by ticket 12: the class is now `SmileyComponent` in `smiley.component.*`, and the notice the layout note above refers to has been replaced by a Material snack bar.
